...
## Files
- **docs/NHS_SPC_Details.pdf** – Full explanation of the SPC workflow, baseline logic, sigma/variation calculation, control limits, run rules, and example output. (This document was provided during the hackathon.)
